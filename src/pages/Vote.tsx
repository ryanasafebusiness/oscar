                      ...
                      <CardContent className="p-0 relative overflow-hidden">
                        <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4">
                          ...
                          <div className="relative flex-shrink-0 w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden">
                            ...
                            {/* Check icon */}
                            {isSelected && (
                              <div className="absolute top-1 right-1 bg-gold text-primary-foreground rounded-full p-1 animate-in zoom-in-50">
                          ...
                          <div className="flex-1 min-w-0 space-y-1">
                            <h3 className="text-base md:text-lg font-bold text-foreground group-hover:text-gold transition-colors truncate">
                              {participant.name}
                            </h3>
